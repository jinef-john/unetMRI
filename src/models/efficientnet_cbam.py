...
if __name__ == '__main__':
    ...
    OLD_PTH = r'E:\MRI_LOWMEM\C1-B3-MRI\MRI-C1EfficientNet_B3.pth'
    NEW_PTH = r'E:\MRI_LOWMEM\C1-B3-CBAM\MRI-C1EfficientNet_B3_CBAM.pth'
    NUM_CLASSES = 4
    IMG_SIZE = 512
    BATCH_SIZE = 32
    NUM_EPOCHS = 5
    ...
    model.base.features[0][0] = nn.Conv2d(1, 40, kernel_size=3, stride=2, padding=1, bias=False)
