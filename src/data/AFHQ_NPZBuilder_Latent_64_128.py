...
from AFHQ_Encoder_Latent_64_128_Train import Encoder  # Adjust as needed

# ====== CONFIG ======
DATA_DIR = r'E:\AFHQ\tiny_train'
SAVE_DIR = r'E:\AFHQ\NPZ_latent_skip64_skip128'
MODEL_PATH = r'E:\AFHQ\models_latent_64_128\autoencoder_epoch7.pth'
BATCH_SIZE = 32  # Set for good GPU utilization
NUM_WORKERS = 8  # DataLoader workers, not process workers
