...
class Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        latent = self.cbam(x5)
        return latent, x4  # skip128 (x3) убираем
...
class Decoder(nn.Module):
    def __init__(self, bottleneck_channels=1024):
        ...
        self.deconv3 = nn.ConvTranspose2d(256, 128, 4, 2, 1)    # убираем +256
    ...
    def forward(self, latent, skip64):
        ...
        x = self.relu(self.dbn3(self.deconv3(x)))   # skip128 больше нет
...
class AutoEncoder(nn.Module):
    ...
    def forward(self, x):
        latent, skip64 = self.encoder(x)
        x_hat = self.decoder(latent, skip64)
        return x_hat
    def decode_latents(self, latent, skip64):
        return self.decoder(latent, skip64)
...
def main():
    ...
    MODEL_SAVE_DIR = r'E:\MRI_LOWMEM\Encoder_latent_64'
    LOG_FILE = r'E:\MRI_LOWMEM\Encoder_latent_64\trainlog.csv'
