...
if __name__ == '__main__':
    ...
    MODEL_PATH = r'E:\AFHQ_LOWMEM\C1-B3\C1EfficientNet_B3.pth'
    LOG_CSV = r'E:\AFHQ_LOWMEM\C1-B3\classifierEFN_B3_train_log.csv'
    CONF_MAT_DIR = r'E:\AFHQ_LOWMEM\C1-B3\confusion_matrices'
