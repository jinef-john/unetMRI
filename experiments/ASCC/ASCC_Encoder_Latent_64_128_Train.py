...
ae_augment = transforms.Compose([
    ...
    transforms.ColorJitter(brightness=0.07, contrast=0.07, saturation=0, hue=0),
    transforms.ToTensor(),
    transforms.Normalize([0.5], [0.5]),
    transforms.RandomErasing(p=0.01, scale=(0.01, 0.03), ratio=(0.3, 2.5), value='random'),
])
...
def main():
    ...
    MODEL_SAVE_DIR = r'E:\ASCC_LOWMEM\Encoder_latent_64_128'
    LOG_FILE = r'E:\ASCC_LOWMEM\Encoder_latent_64_128\trainlog.csv'
    ...
    loader = DataLoader(dataset, batch_size=20, shuffle=True, num_workers=4, pin_memory=True)
